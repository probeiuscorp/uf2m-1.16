...
public class ArmorConditionFromProperties extends ArmorCondition {
	private Integer[] minStats;
	
	public ArmorConditionFromProperties(String unlocalizedName, ArmorConditionAlignment alignment, Set<IAlloyItem> validOn, Integer[] minStats) {
